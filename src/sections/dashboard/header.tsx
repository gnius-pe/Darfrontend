...
const Header = (props: {
  ...
  return (
    <header className="top-0 h-14 w-full bg-custom-blue flex items-center">
        ...
        <div className="flex items-center gap-3 2xsm:gap-7">
          ...
          <div className="flex items-center gap-3">
            <select name="" id="" className="mr-2 px-4 py-1 rounded-2xl">
              <option className="bg-white" value="las">
                San Diego
              </option>
              <option className="bg-white" value="DNI">
                La Libertad
              </option>
              <option className="bg-white" value="Pasaporte">
                Ancash
              </option>
            </select>
