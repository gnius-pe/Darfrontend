		...
		<>
			<div className='h-72 flex flex-col justify-center items-center gap-4'>
				<div className='flex flex-col items-center gap-4'>
					...
					<p> Tu cita a sido reservada con exito con codigo {numberFile}, por favor imprime tu ficha</p>
					<button className='px-2 py-2 bg-custom-skyblue rounded-md '>descargar ficha</button>
				</div>
				<button className='bg-blue-900 px-3 py-2 rounded-md text-white'> Registrar otro paciente</button>
				</div>
		</>
  );
};
